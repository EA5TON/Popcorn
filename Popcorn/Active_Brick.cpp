...
//------------------------------------------------------------------------------------------------------------------------
double AActive_Brick::Get_Brick_X_Pos (bool of_cenert)
{
...
//------------------------------------------------------------------------------------------------------------------------
double AActive_Brick::Get_Brick_Y_Pos (bool of_cenert)
{
   ...
   else
   {
      ...
      case ETS_Finishing:
         ...
         if (Ball != 0)
         {
            ...
            Ball = 0; // Отмечаем мяч как отсутствующий в телепорте.
            InvalidateRect (AsConfig::hwnd, &Brick_Rect, FALSE);
         }
         break;
      }
