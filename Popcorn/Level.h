...
public:
   ...
   AsLevel ();
    ...
    static char Level_1 [AsConfig::Level_Height][AsConfig::Level_Width];
...
private:
    ...
    void Act_Objects (AGraphics_Object **objects_array, int &objects_count, const int object_max_count);
